...
//import com.bt.beertinder.model.Preference;
//import com.bt.beertinder.model.User;
//import com.bt.beertinder.repository.*;
//import org.springframework.boot.CommandLineRunner;
//import org.springframework.context.annotation.Bean;
//import org.springframework.context.annotation.Configuration;
//
...
//            List<User> users = Arrays.asList(
//                    User.builder()
//                .username("katarzyna_kowalczyk")
//                .email("katarzyna.kowalczyk@example.com")
//                .preferences(new ArrayList<>())
//                .build(),
//            User.builder()
//                .username("marcin_lewandowski")
//                .email("marcin.lewandowski@example.com")
//                .preferences(new ArrayList<>())
//                .build(),
//            User.builder()
//                .username("agnieszka_zielinska")
//                .email("agnieszka.zielinska@example.com")
//                .preferences(new ArrayList<>())
//                .build(),
//            User.builder()
//                .username("tomasz_wozniak")
//                .email("tomasz.wozniak@example.com")
//                .preferences(new ArrayList<>())
//                .build(),
//            User.builder()
//                .username("joanna_sawicka")
//                .email("joanna.sawicka@example.com")
//                .preferences(new ArrayList<>())
//                .build(),
//            User.builder()
//                .username("pawel_dabrowski")
//                .email("pawel.dabrowski@example.com")
//                .preferences(new ArrayList<>())
//                .build(),
//            User.builder()
//                .username("monika_kaczmarek")
//                .email("monika.kaczmarek@example.com")
//                .preferences(new ArrayList<>())
//                .build(),
//            User.builder()
//                .username("krzysztof_pietrzak")
//                .email("krzysztof.pietrzak@example.com")
//                .preferences(new ArrayList<>())
//                .build(),
//            User.builder()
//                .username("natalia_michalska")
//                .email("natalia.michalska@example.com")
//                .preferences(new ArrayList<>())
//                .build(),
//            User.builder()
//                .username("mateusz_nowicki")
//                .email("mateusz.nowicki@example.com")
//                .preferences(new ArrayList<>())
//                .build(),
//            User.builder()
//                .username("ewa_adamczyk")
//                .email("ewa.adamczyk@example.com")
//                .preferences(new ArrayList<>())
//                .build(),
//            User.builder()
//                .username("andrzej_jablonski")
//                .email("andrzej.jablonski@example.com")
//                .preferences(new ArrayList<>())
//                .build(),
//            User.builder()
//                .username("marta_sikorska")
//                .email("marta.sikorska@example.com")
//                .preferences(new ArrayList<>())
//                .build(),
//            User.builder()
//                .username("piotr_majewski")
//                .email("piotr.majewski@example.com")
//                .preferences(new ArrayList<>())
//                .build(),
//            User.builder()
//                .username("anna_olszewska")
//                .email("anna.olszewska@example.com")
//                .preferences(new ArrayList<>())
//                .build(),
//            User.builder()
//                .username("janusz_wisniewski")
//                .email("janusz.wisniewski@example.com")
//                .preferences(new ArrayList<>())
//                .build(),
//            User.builder()
//                .username("aleksandra_kowalska")
//                .email("aleksandra.kowalska@example.com")
//                .preferences(new ArrayList<>())
//                .build(),
//            User.builder()
//                .username("barbara_krupa")
//                .email("barbara.krupa@example.com")
//                .preferences(new ArrayList<>())
//                .build(),
//            User.builder()
//                .username("michal_zajac")
//                .email("michal.zajac@example.com")
//                .preferences(new ArrayList<>())
//                .build(),
//            User.builder()
//                .username("justyna_krol")
//                .email("justyna.krol@example.com")
//                .preferences(new ArrayList<>())
//                .build()
//
//            );
...
//                        .participants(Arrays.asList(match.getUser1(), match.getUser2()))
//                        .build());
//            }
